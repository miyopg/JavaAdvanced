 ...
 *  - przez zwrócenie wyjątku metodzie "wyżej" klauzylą throws
 */
...
public class TryCatchSample {
    ...
    public void sleepThread(long miliseconds) {
        try {
            ...
            // to blok catch jest ignorowany, nie wykonuję się kod który tam jest napisany
